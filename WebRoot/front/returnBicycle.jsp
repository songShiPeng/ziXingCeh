...
<jsp:include page="../top.jsp" flush="true" />
	...
	<div class="main">
	<form action="saveReturnBicycle.html" method="post">
	<table class=".table-bordered" width="100%">
	<tr><td  align="center">自行车归还</td></tr>
	<tr>
	
	<td align="center">
		
   编号： <form:input path="bicycleInfo.bicycleNumber"   value="${bicycleInfo.bicycleNumber}" autocomplete="off"/>
   </td></tr>
   
   
    
     <tr><td> <button type="submit">确定</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.history.back();"></input></td></tr>
    </table>
     </form>
	</div>
        <!--/.fluid-container-->
