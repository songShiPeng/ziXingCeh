...
<jsp:include page="../top.jsp" flush="true" />
	...
	<div class="main">
	<form action="saveBorrowrecord.html" method="post"  onsubmit="return mySub();">
	<table class=".table-bordered" width="100%">
	<tr><td  align="center" colspan="2" >办理借车</td></tr>
	<tr>
   ...
   <form:input path="borrowRecordInfo.bicycleName"   value="${borrowRecordInfo.bicycleName}" style="width:120px;" autocomplete="off"/>
   </td></tr>
   <tr>
	 <td align="right" width="40%">
	 用户账号  ：
 ...
 <form:input path="borrowRecordInfo.userName"   value="${borrowRecordInfo.userName}" style="width:120px;" autocomplete="off"/>
   </td></tr>
   <tr>
    ...
    <tr><td colspan="2" align="center"><font color="red"><c:out value="${messege}"/></font></td></tr>
    </table>
     </form>
	</div>
        <!--/.fluid-container-->
